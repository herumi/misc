...
abstract class Common {
  ...
  _setter (func: Function, ...params: unknown[]): void {
    const stack = mod.stackSave()
    const pos = this._salloc()
  ...
  /** @internal getter */
  _getter (func: Function, ...params: unknown[]): unknown {
    const stack = mod.stackSave()
